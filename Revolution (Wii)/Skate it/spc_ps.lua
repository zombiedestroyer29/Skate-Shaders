...
//
// (SPEC * SPECMASK)
// this DEBUG shader only outputs spec * specmask
//
GXSetTevOrder(GX_TEVSTAGE5, GX_TEXCOORD2, GX_TEXMAP3, GX_COLOR_NULL);
GXSetTevColorIn(GX_TEVSTAGE5, GX_CC_ZERO, GX_CC_APREV, GX_CC_TEXC, GX_CC_ZERO);
GXSetTevColorOp(GX_TEVSTAGE5, GX_TEV_ADD, GX_TB_ZERO, GX_CS_SCALE_1, GX_TRUE, GX_TEVPREV);
GXSetTevAlphaIn(GX_TEVSTAGE5, GX_CA_ZERO, GX_CA_ZERO, GX_CA_ZERO, GX_CA_ONE);
