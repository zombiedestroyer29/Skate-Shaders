...
// (empty) FOR SPEC - REVISIT
//
GXSetTevOrder(GX_TEVSTAGE2, GX_TEXCOORD4, GX_TEXMAP2, GX_COLOR_NULL);
...
GXSetTevColorIn(GX_TEVSTAGE3, GX_CC_ZERO, GX_CC_C2, GX_CC_TEXC, GX_CC_ZERO);
GXSetTevColorOp(GX_TEVSTAGE3, GX_TEV_ADD, GX_TB_ZERO, GX_CS_SCALE_2, GX_FALSE, GX_TEVREG2);
...
//
GXSetTevOrder(GX_TEVSTAGE4, GX_TEXCOORD2, GX_TEXMAP3, GX_COLOR_NULL);
GXSetTevColorIn(GX_TEVSTAGE4, GX_CC_ZERO, GX_CC_APREV, GX_CC_TEXC, GX_CC_C2);
GXSetTevColorOp(GX_TEVSTAGE4, GX_TEV_ADD, GX_TB_ZERO, GX_CS_SCALE_1, GX_TRUE, GX_TEVPREV);
GXSetTevAlphaIn(GX_TEVSTAGE4, GX_CA_ZERO, GX_CA_ZERO, GX_CA_ZERO, GX_CA_A2);
...
//
GXSetTevOrder(GX_TEVSTAGE5, GX_TEXCOORD5, GX_TEXMAP4, GX_COLOR_NULL);
GXSetTevColorIn(GX_TEVSTAGE5, GX_CC_CPREV, GX_CC_ZERO, GX_CC_ZERO, GX_CC_TEXC);
GXSetTevColorOp(GX_TEVSTAGE5, GX_TEV_ADD, GX_TB_SUBHALF, GX_CS_DIVIDE_2, GX_TRUE, GX_TEVPREV);
