...
GXSetTevColorIn(GX_TEVSTAGE1, GX_CC_ONE, GX_CC_ZERO, GX_CC_TEXC, GX_CC_ZERO);
...
GXSetTevColorIn(GX_TEVSTAGE4, GX_CC_ZERO, GX_CC_ZERO, GX_CC_ZERO, GX_CC_TEXC);
...
// ENV
GXSetTevOrder(GX_TEVSTAGE6, GX_TEXCOORD5, GX_TEXMAP3, GX_COLOR_NULL);
GXSetTevColorIn(GX_TEVSTAGE6, GX_CC_ZERO, GX_CC_TEXC, GX_CC_CPREV, GX_CC_C2);
