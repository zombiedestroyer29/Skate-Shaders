...
half3 cDiffuse_Flat = GetDiffuseTextureValue ( i_diffuse , diffuse1uv ).xyz;
half3 cDiffuse_Slope = GetDiffuseTextureValue ( i_diffuse2 , diffuse2uv ).xyz;
...
half3 cSpecEccRefMask_Slope = GetSpecularEccentricityReflectionMaskValue ( i_specular2 , diffuse2uv );
...
half3 tbnLightdir = TransformToTangentFromWorld ( g_vLightDir , matTBN );
...
half4 outcolor = half4 ( diffTerm*cDiffuse+specTerm, 1 );
...
outcolor = ChooseDebugTexture ( outcolor , tex2D ( i_chromaticity , In.UV.zw ) , half4 ( 0, 0, 0, 0 ) , tex2D ( i_normal2 , diffuse2uv ) , half4 ( cDiffuse, 1 ) , half4 ( cSpecEccRefMask.ggg, 1.0 ) , black4 , half4 ( cLightMap.aaa, 1.0 ) , half4 ( cOverlay, 1 ) , tex2D ( i_normal , diffuse1uv ) , half4 ( cSpecEccRefMask.bbb, 1.0 ) , half4 ( cSpecEccRefMask.rrr, 1.0 ) );
