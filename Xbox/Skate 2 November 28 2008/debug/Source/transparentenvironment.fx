...
half3 specTerm = GetSpecularTerm ( i_environment , g_vLightDir.xyz , vNormal , vViewDir , cSpecEccRefMask , cLightMap.a , g_envattributes[5].xyz , g_envattributes[2].w , ( g_envattributes[4].xyz*3 ) , g_envattributes[3].w , g_envattributes[4].w , g_envattributes[5].w , g_envattributes[6].yzw , specTermParts );


half4 outcolor = ( half4 ( diffTerm, 1 )*cDiffuse )*cDiffuse.a+half4 ( specTerm, 0 );

half3 black3 = half3 ( 0, 0, 0 );
half4 black4 = half4 ( black3, 1.0 );
outcolor = ChooseDebugLighting ( outcolor , diffTerm , cLightMap.rgb , specTermParts.calculated , black3 , specTermParts.reflected , black3 , diffTerm+specTerm );
outcolor = ChooseDebugTexture ( outcolor , tex2D ( i_chromaticity , In.UV.zw ) , black4 , black4 , cDiffuse , half4 ( cSpecEccRefMask.ggg, 1.0 ) , GetDebugReflectClr ( i_environment , vNormal , vViewDir ) , half4 ( cLightMap.aaa, 1.0 ) , black4 , black4 , half4 ( cSpecEccRefMask.bbb, 1.0 ) , half4 ( cSpecEccRefMask.rrr, 1.0 ) );
